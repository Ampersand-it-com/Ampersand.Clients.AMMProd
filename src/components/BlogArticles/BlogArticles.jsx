...
function BlogArticles() {
  ...
  const content = useMemo(
    () => [
      {
        link: "https://www.youtube.com/embed/panmKr1Gtro",
        preview: "https://i.ytimg.com/vi/panmKr1Gtro/hqdefault.jpg",
        title: t("blog.articles.0.title"),
        description: t("blog.articles.0.description"),
        page: toPage("/blog/3d-real-world"),
      },
      {
      ...
      },
      {
        ...
        description: t("blog.articles.3.description"),
