...
export default function ArticleAiAlternativeBody() {
  ...
  return (
    <div className={s.article} id="article-body">
      ...
      <section className={s.chapter}>
        ...
        <ul className={s.list}>
          <li className={s.listItem}>
            ...
            {t("articleAiAlternative.chapter3.list.0")}
          </li>
          <li className={s.listItem}>
            <StarIcon className={s.starIcon} />
            {t("articleAiAlternative.chapter3.list.1")}
          </li>
          <li className={s.listItem}>
            <StarIcon className={s.starIcon} />
            {t("articleAiAlternative.chapter3.list.2")}
          </li>
        </ul>
      ...
      <section className={s.chapter}>
        <div className={s.cardFilled}>
          <p className={s.lead}>{t("articleAiAlternative.chapter7.title")}</p>
          <ul className={s.list}>
            <li className={s.listItem}>
              <StarIcon className={s.starIcon} />
              {t("articleAiAlternative.chapter7.list.0")}
            </li>
            <li className={s.listItem}>
              <StarIcon className={s.starIcon} />
              {t("articleAiAlternative.chapter7.list.1")}
            </li>
            <li className={s.listItem}>
              <StarIcon className={s.starIcon} />
              {t("articleAiAlternative.chapter7.list.2")}
            </li>
            <li className={s.listItem}>
              <StarIcon className={s.starIcon} />
              {t("articleAiAlternative.chapter7.list.3")}
            </li>
            <li className={s.listItem}>
              <StarIcon className={s.starIcon} />
              {t("articleAiAlternative.chapter7.list.4")}
            </li>
          </ul>
        </div>
      </section>
